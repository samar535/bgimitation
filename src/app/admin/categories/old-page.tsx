                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-2">
                    <button
                        ...
                        className="flex-1 cursor-pointer flex items-center justify-center gap-2 px-4 py-3 bg-blue-50 text-blue-600 rounded-xl hover:bg-blue-100 transition-colors font-semibold"
                    >
                        <Edit size={16} />
                        Edit
                    </button>
          ...
          {categories.map((category) => (
            <div key={category.id} className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              <div className="p-3 pt-0 flex gap-3">
                <Button
                  onClick={() => startEdit(category)}
                  variant="outline" className="w-full cursor-pointer! border-green-300! text-green-700! px-4! sm:px-6! py-2! sm:py-3!">
                    <Edit size={18} />
                    Edit
                </Button>
                <Button 
                  variant="outline" 
                  className="flex-1 cursor-pointer! border-red-200 px-4! sm:px-6! py-2! sm:py-3! border-red-700! text-red-700! hover:bg-red-50"
                  onClick={() => handleDelete(category.id, category.name)}
                >
                  <Trash2 size={18} />
                  Delete
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            ...
            <div className="p-4 sm:p-8">
                ...
                <div className="flex gap-4 mt-8">
                    ...
                    onClick={resetForm}
                    size="lg"
                    className=' cursor-pointer px-4! sm:px-8! py-2! sm:py-3!'
                    >
                    Cancel
                    </Button>
                </div>
