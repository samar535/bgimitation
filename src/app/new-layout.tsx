    ...
    <html lang="en">
      <body className={`${inter.className} ${playfair.className}`}>
        ...
        <a
          ...
          className="fixed bottom-20 right-6 w-16 h-16 bg-[#25D366] rounded-full shadow-2xl flex items-center justify-center z-50 hover:scale-110 transition-transform lg:bottom-6"
        >
